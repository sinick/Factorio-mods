...
local Items = {{ItemPrototypes["Robot"], settings.global["NCA-BuilderBotStart-starting-robot-count"].value}}
local ArmorModules = {
	--Vanilla, 10x10 grid
...
script.on_init(function(event)
	local speed = settings.global["NCA-BuilderBotStart-faster-robots"].value
	if not(speed == 0) then
